...
//        }
        if UserDefaults.standard.object(forKey: "status") as? String == "Login Successfully" {
            let storyboard = UIStoryboard(name: "Profile", bundle: nil)
            let landingScrene = storyboard.instantiateViewController(withIdentifier:"CFHomeVC" )
