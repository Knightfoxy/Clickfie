//
//  testingUIViewController.swift
//  ClickFie
//
//  Created by Ayush Mishra on 18/05/22.
//

import UIKit

class TestingUIViewController: UIViewController {
    @IBOutlet private(set) weak var  testView : UIView!
    override func viewDidLoad() {
        super.viewDidLoad()
        self.testView.addTopRoundedCornerToView(targetView: testView, desiredCurve: 10)
    }
}
extension UIView {
